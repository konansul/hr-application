  ...
  return (
    <div className="w-full max-w-none mx-auto space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Compare Candidates</h2>
          <p className="text-sm text-gray-500">Select up to 3 candidates for a side-by-side evaluation.</p>
        </div>
      </div>

          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="space-y-3">
              ...
              <div
                ...
                className={`flex items-center border border-gray-300 dark:border-neutral-700 rounded-xl bg-white dark:bg-black overflow-hidden transition-all ${isProcessing ? 'opacity-60 cursor-not-allowed' : 'cursor-pointer hover:border-[#7A60F4]/50 dark:hover:border-[#7A60F4]/50'}`}
              >
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                disabled={isProcessing}
                className="w-full min-h-[140px] px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-neutral-500 bg-gray-50 dark:bg-black border border-gray-300 dark:border-neutral-700 rounded-xl hover:border-[#7A60F4]/50 dark:hover:border-[#7A60F4]/50 focus:ring-2 focus:ring-[#7A60F4]/40 focus:border-[#7A60F4]/60 focus:outline-none transition-all resize-y"
              />
            </div>
          </div>

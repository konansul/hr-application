      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white dark:bg-zinc-950 transition-colors relative">
        <div className="w-full max-w-[420px] animate-in fade-in slide-in-from-bottom-8 duration-700 relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <label htmlFor="hr-consent-checkbox" className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-relaxed cursor-pointer select-none">
                    {t.consentStart}{' '}
                    <a href={TERMS_URL} target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 underline underline-offset-2 hover:no-underline" onClick={e => e.stopPropagation()}>
                      {t.tos}
                    </a>
                    {' '}{t.consentAnd}{' '}
                    <a href={PRIVACY_URL} target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 underline underline-offset-2 hover:no-underline" onClick={e => e.stopPropagation()}>
                      {t.hrPp}
                    </a>
                    .
                  </label>
            ...
            {/* === УНИВЕРСАЛЬНЫЙ ФУТЕР (ВХОД И РЕГИСТРАЦИЯ) === */}

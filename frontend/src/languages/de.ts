export const de = {
  ...
  profile: {
    ...
    notCompleted: "Nicht ausgefüllt — zum Ausfüllen klicken",
    requiredFields: "Bitte füllen Sie die Pflichtfelder aus",
    required: "Pflichtfeld",
    selectVisaStatus: "Bitte wählen Sie einen Visastatus",
    selectWorkPreference: "Bitte wählen Sie eine Arbeitspräferenz",
  ...
  jobs: {
    ...
    filterTooltipPlatformTitle: "Suche in Plattform-Stellen.",
    filterTooltipPlatformBody: "Ergebnisse werden unter den auf dieser Plattform geposteten Stellen gefiltert.",
    filterTooltipPlatformSwitch: "Wechseln Sie zum Stellenmarkt für eine weltweite Suche.",
    filterTooltipMarketTitle: "Suche im Stellenmarkt.",
    filterTooltipMarketBody: "Ergebnisse werden über aktuelle Stellenanzeigen von Jobbörsen weltweit gefiltert.",
    filterTooltipSwitchLink: "Zum Stellenmarkt wechseln",
    ...
    jobCountFoundSingular: "1 Stelle gefunden",
    jobCountFoundPlural: "{count} Stellen gefunden",

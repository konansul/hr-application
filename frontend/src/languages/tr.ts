export const tr = {
  ...
  profile: {
    ...
    notCompleted: "Tamamlanmadı — doldurmak için tıklayın",
    requiredFields: "Lütfen zorunlu alanları doldurun",
    required: "Zorunlu",
    selectVisaStatus: "Lütfen bir vize durumu seçin",
    selectWorkPreference: "Lütfen bir çalışma tercihi seçin",
  ...
  jobs: {
    ...
    filterTooltipPlatformTitle: "Platform İşlerinde aranıyor.",
    filterTooltipPlatformBody: "Sonuçlar bu platformda yayınlanan işler arasında filtrelenir.",
    filterTooltipPlatformSwitch: "Küresel arama için İş Piyasası'na geçin.",
    filterTooltipMarketTitle: "İş Piyasasında aranıyor.",
    filterTooltipMarketBody: "Sonuçlar dünya genelindeki iş panolarından canlı ilanlar arasında filtrelenir.",
    filterTooltipSwitchLink: "İş Piyasası'na geç",
    ...
    jobCountFoundSingular: "1 iş ilanı bulundu",
    jobCountFoundPlural: "{count} iş ilanı bulundu",

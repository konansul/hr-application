export const en = {
  ...
  settings: {
    ...
    private: "Private",
    privateDesc: "Not visible to anyone. Your profile is completely hidden.",
  ...
  profile: {
    ...
    notCompleted: "Not completed — click to fill in",
    requiredFields: "Please complete required fields",
    required: "Required",
    selectVisaStatus: "Please select a visa status",
    selectWorkPreference: "Please select a work preference",
  ...
  jobs: {
    ...
    jobCountFoundSingular: "1 job found",
    jobCountFoundPlural: "{count} jobs found",

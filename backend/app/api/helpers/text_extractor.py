...
def _map_linkedin_to_profile(data: dict, source_url: str, existing_email: str = "") -> dict:
    ...
    return {
        "personal_info": {
            ...
            "linkedin_url": source_url if "linkedin.com" in source_url.lower() else "",
            "github_url": source_url if "github.com" in source_url.lower() else "",
            "portfolio_url": source_url if "linkedin.com" not in source_url.lower() and "github.com" not in source_url.lower() else "",
            "summary": summary,
        },
